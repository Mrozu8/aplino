...
//                }
//
//                return redirect('/company/'. $user->id .'/payment')->with('status-success', 'Status konta został zmieniony na'.$status);   //  Zamiana gorszego na lepszy
//            }


            Mail::to($user->email)->send(new Payment());
            return redirect('/company/'. $user->id .'/payment')->with('status-success', 'Transkacja przebiegła pomyślnie');   //  Zamiana gorszego na lepszy
