...
@section('content')
    ...
    <section class="section section-lg bg-gradient-default">
        <div class="container pt-lg pb-100">
            <div class="row text-center justify-content-center">
                <div class="col-lg-10">
                    <h2 class="display-3 text-white">Polityka prywatności</h2>
                </div>
            </div>
        </div>
        <!-- SVG separator -->
    ...
    <div class="privacy policy">
        <div class="container pt-100">
            ...
            <ul>
                <li><p><strong>Serwis</strong> - serwis internetowy działający pod adresem <span id="serwis"><span class="colored">www.aplino.com</span></span></p></li>
                <li><p><strong>Serwis zewnętrzny</strong> - serwis internetowe partnerów, usługodawców lub usługobiorców Administratora</p></li>
                <li><p><strong>Administrator</strong> - firma <span id="firma"><span class="colored">SOWIT Hubert Mrozek</span>, prowadząca działalność pod adresem: <span class="colored">3-maja 25, 37-555 Sośnica</span>, o nadanym numerze identyfikacji podatkowej (NIP): <span class="colored">7922298371</span></span>, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu oraz przechowująca i uzyskująca dostęp do informacji w urządzeniach Użytkownika</p></li>
            ...
            <ul id="zewnetrzne"><li><p><strong><span class="colored">Google Analytics</span></strong></p></li><li><p><strong><span class="colored">Google AdSense</span></strong></p></li><li><p><strong>Google AdWords</strong></p></li> <li><p><strong><span class="colored">Google+</span></strong></p></li><li><p><strong><span class="colored">Facebook</span></strong></p></li></ul>
