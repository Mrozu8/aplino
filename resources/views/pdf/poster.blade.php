...
<div class="invoice">
    ...
    <div class="head" style="text-align: center; padding-top: 60px;">
        <p>Ogłoszenie o prace</p>
    </div>
    <div class="head" style="text-align: center; padding-top: 60px;">
        <p>{{ $form->title }}</p>
    </div>
    <div class="head" style="text-align: center; padding-top: 60px;">
        <p>Koniec rekrutacji: {{ $form->active_date }}</p>
    </div>
    <div class="head" style="text-align: center; padding-top: 60px;">
        <p>Formularz na stronie: http://www.i-cv.pl/curriculum-vitae/{{ $form->id }}</p>
    </div>
    <div class="head" style="text-align: center; padding-top: 60px;">
        {{--<p>{{ $qr }}</p>--}}
    </div>
    {{--<img src="{{ route('qr', $form->id) }}" alt="" style="width: 200px; height: 200px;">--}}
    {{--<img src="{{ asset('storage/qr/file.png') }}" alt="" style="width: 200px; height: 200px;">--}}
